...
func TestNewEnvironment(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Create env service with default envs", want: &Environment{
			...
			ApplicationEnvs: *NewApplicationEnvs("/app", defaultLaunchSite, defaultProjectId, defaultPipelinesFolder, defaultBucketName, defaultPlaygroundSalt, defaultDatastoreEmulatorHost, defaultOrigin, &CacheEnvs{defaultCacheType, defaultCacheAddress, defaultCacheKeyExpirationTime}, defaultPipelineExecuteTimeout, defaultDBType, defaultMaxSnippetSize, defaultIdLength),
		}},
	}
...
func Test_getApplicationEnvsFromOsEnvs(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:      NewApplicationEnvs("/app", defaultLaunchSite, defaultProjectId, defaultPipelinesFolder, defaultBucketName, defaultPlaygroundSalt, defaultDatastoreEmulatorHost, defaultOrigin, &CacheEnvs{defaultCacheType, defaultCacheAddress, convertedTime}, defaultPipelineExecuteTimeout, defaultDBType, defaultMaxSnippetSize, defaultIdLength),
			wantErr:   false,
		...
		{
			name:      "CacheKeyExpirationTimeKey is set with the correct value",
			want:      NewApplicationEnvs("/app", defaultLaunchSite, defaultProjectId, defaultPipelinesFolder, defaultBucketName, defaultPlaygroundSalt, defaultDatastoreEmulatorHost, defaultOrigin, &CacheEnvs{defaultCacheType, defaultCacheAddress, defaultCacheKeyExpirationTime}, convertedTime, defaultDBType, defaultMaxSnippetSize, defaultIdLength),
			wantErr:   false,
